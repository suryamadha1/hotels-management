...
public class RoomsController {
	...
	@PostMapping("/addRoom")
	@ResponseBody
	private ResponseEntity<Rooms> addRoom(@RequestBody Rooms room){
	...
	@ResponseBody
	private ResponseEntity<String> bookRoomById(@RequestParam List<Integer> room_ids, @RequestBody Transaction transaction){
